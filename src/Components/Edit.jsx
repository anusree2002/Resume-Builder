...
const handleUpdateResume=async()=>{
  try{
    ...
    swal("Success", "Resume Update", "success");
    handleClose()
  ...
  return (
    <div>
      <button className='btn text-primary fs-3' onClick={handleOpen}><FaEdit/></button>
      <Modal
        open={open}
        onClose={handleClose}
            ...
            <h3>Education Details</h3>
             ...
             {/* professional details */}
              <h3>Professional Details</h3>
               ...
               {/*Skills  */}
                  <h3>Skills</h3>
                  <div className='d-flex justify-content-between m-3 align-item-center'>
                      <TextField id="standard-basic" label="Add Skill" variant="standard"  onChange={
                        e=>setUserSkill(e.target.value)} value={userSkill}/>
              ...
              <div className="d-flex justify-content-between">
                ...
                <span className='btn btn-primary d-flex align-item-center justify content center'>{skill}
                  <button style={{marginTop:'-7px'}} className='btn text-light' onClick={()=>removeSkill(skill)}>X</button>
                </span>
                 ))}
              </div>
              ...
              {/* professional  Summary*/}
               <h3>Professional Summary</h3>
                        <div className="d-flex row p-3">
                        <TextField 
                                   id="standard-multiline-static"  label="Write a short summary of yourself" 
                                   multiline 
                                   rows={4} 
                                    variant="standard"
