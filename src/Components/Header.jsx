      ...
      <AppBar position="static">
        <Toolbar>
          <IconButton
            ...
            sx={{ mr: 2 }}
          >
            <img width={'40px'} src="https://cdn-icons-png.flaticon.com/512/6614/6614677.png" alt="logo" />
          </IconButton>
          <Typography variant="h6" component="div" sx={{ flexGrow: 1, fontWeight:'bold'}}>
            <Link to={'/'} style={{textDecoration:'none',color:'white'}}>Resume-Builder</Link>   {/*  to={'/'}   used to redirect to the landing page whenever click on the text "Resume-Builder" on header section */}
          </Typography>
